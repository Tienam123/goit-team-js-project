...
const bottomBurgerMenuBtn = document.querySelector('.link-work');
// const bottomBurgerMenuBtn = document.querySelector('.link-header-link');
...
menuBirgerLink.forEach(element =>
